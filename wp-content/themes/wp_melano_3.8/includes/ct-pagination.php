	...
	*/
	...
	if (!function_exists('pagenavi')) { 
		function pagenavi($query, $before = '', $after = '') {
		    ...
		    $pagenavi_options['first_text'] = __('First Page', 'cootheme');
		    $pagenavi_options['last_text'] = __('Last Page', 'cootheme');
		    $pagenavi_options['next_text'] = __("Next <i class='ss-navigateright'></i>", "cootheme");
		    $pagenavi_options['prev_text'] = __("<i class='ss-navigateleft'></i> Previous", "cootheme");
