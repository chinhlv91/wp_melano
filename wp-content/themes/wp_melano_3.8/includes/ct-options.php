    				...
    				'fields' => array(
    					...
    					array(
       					...
       					array(
    						...
    						'desc' => '',
    						'options' => array(
								'header-1' => array('title' => '', 'img' => Redux_OPTIONS_URL.'img/header1.jpg'),
								'header-2' => array('title' => '', 'img' => Redux_OPTIONS_URL.'img/header2.jpg'),
								'header-3' => array('title' => '', 'img' => Redux_OPTIONS_URL.'img/header3.jpg'),
								'header-4' => array('title' => '', 'img' => Redux_OPTIONS_URL.'img/header4.jpg'),
								'header-5' => array('title' => '', 'img' => Redux_OPTIONS_URL.'img/header5.jpg'),
								'header-6' => array('title' => '', 'img' => Redux_OPTIONS_URL.'img/header6.jpg'),
								'header-7' => array('title' => '', 'img' => Redux_OPTIONS_URL.'img/header7.jpg')
							),
    						'std' => 'header-7'
    						),
    					array(
    ...
    $sections[] = array(
    				...
    				'fields' => array(
    					...
    					array(
    						...
    						'desc' => '',
    						'std' => "Copyright © 2008 - 2013 apl.vn. All rights reserved."
    						),
    					array(
    						'id' => 'show_backlink',
    						'type' => 'button_set',
	...
	$sections[] = array(
					...
					'fields' => array(
						...
						array(
							...
							'options' => ct_get_woo_product_filters_array(),
							'desc' => '',
							'std' => 'product_cat'
							),
						array(
