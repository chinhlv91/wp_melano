		...
		<article <?php post_class('clearfix row'); ?> id="<?php the_ID(); ?>" itemscope itemtype="http://schema.org/BlogPosting">
			...
			<div class="page-content col-sm-12 clearfix">
				...
				<div class="post-info clearfix">
					<span><?php echo sprintf(__('Posted by <a href="%2$s">%1$s</a> on %3$s in %4$s', 'cootheme'), $post_author, get_author_posts_url(get_the_author_meta( 'ID' )), $post_date, $post_categories); ?></span>
				...
				<section class="article-body-wrap">
					...
					<div class="share-links curved-bar-styling clearfix">
						<div class="share-text"><?php _e("Share this gallery:", "cootheme"); ?></div>
						<ul>
							<li class="ct-love">
							<div class="comments-likes">
