...
<?php if ( comments_open() ) : ?><div id="reviews"><?php
	...
	if ( version_compare( WOOCOMMERCE_VERSION, "2.0.0" ) >= 0 ) {
		...
		if ( have_comments() ) :
			...
			echo '<p class="add_review"><a href="#review_form" class="inline ct-button ct-icon-reveal accent" data-toggle="modal" title="' . __( 'Add Your Review', 'woocommerce' ) . '"><i class="ss-write"></i><span class="text">' . $add_review_text . '</span></a></p>';
		...
		echo '<div class="modal-dialog">
		  ...
		  <h2>'.__("Write a review", "cootheme").'</h3>
		</div>';
		...
		if ( get_option('woocommerce_enable_review_rating') == 'yes' ) {
			...
			$comment_form['comment_field'] = '<p class="comment-form-rating"><label for="rating">' . __( 'Overall Rating', 'cootheme' ) .'</label><select name="rating" id="rating">
