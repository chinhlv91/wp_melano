...
<?php
	...
	global $post, $product, $ct_catalog_mode;
	...
	$product_short_description = get_post_meta($post->ID, 'ct_product_short_description', true);
	...
	<div class="summary entry-summary">
		...
		<div class="summary-top clearfix">
			...
			<div itemprop="offers" itemscope itemtype="http://schema.org/Offer">
				...
				<?php if (!$ct_catalog_mode) { ?><link itemprop="availability" href="http://schema.org/<?php echo $product->is_in_stock() ? 'InStock' : 'OutOfStock'; ?>" /><?php } ?>
			...
			<?php
				if ( comments_open() ) {
				    ...
				    if ( $count > 0 ) {
						...
						$reviews_text = sprintf(_n('%d Review', '%d Reviews', $count, 'Cootheme'), $count);
