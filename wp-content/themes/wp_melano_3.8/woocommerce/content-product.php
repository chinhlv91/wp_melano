<?php
	...
	global $product, $woocommerce_loop, $ct_catalog_mode;
...
<li <?php post_class( $classes ); ?>>
    ...
    <?php
    if (ct_is_out_of_stock()) {

        echo '<span class="out-of-stock-badge">' . __( 'Out of Stock', 'cootheme' ) . '</span>';
        ...
        echo '<span class="free-badge">' . __( 'Free', 'cootheme' ) . '</span>';
        ...
        if ( ( time() - ( 60 * 60 * 24 * $newness ) ) < $postdatestamp ) { // If the product was published within the newness time frame display the new badge
            echo '<span class="wc-new-badge">' . __( 'New', 'cootheme' ) . '</span>';
        }
