...
<table class="shop_table my_account_orders">
	...
	<thead>
		<tr>
			...
			<th class="order-amount"><span class="nobr"><?php _e( 'Amount', 'cootheme' ); ?></span></th>
			<th class="order-status"><span class="nobr"><?php _e( 'Status', 'woocommerce' ); ?></span></th>
			<th class="order-actions"><?php _e( 'Details', 'cootheme' ); ?></th>
		</tr>
	</thead>
...
<?php else: ?>
<h3 class="no-orders"><?php _e("You haven't placed any orders yet.", "cootheme"); ?></h3>
<?php endif; ?>
