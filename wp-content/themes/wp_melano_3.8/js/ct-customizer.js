...
( function( $ ){		
	...
	wp.customize('accent_color',function( value ) {
		value.bind(function(to) {
			...
			$('#copyright a,.portfolio-item .portfolio-item-permalink,.read-more-link,.blog-item .read-more,.blog-item-details a,.author-link,.comment-meta .edit-link a,.comment-meta .comment-reply a,#reply-title small a,ul.member-contact,ul.member-contact li a,span.dropcap2,.spb_divider.go_to_top a,.love-it-wrapper .loved,.comments-likes .loved span.love-count,#header-translation p a,.caption-details-inner .details span > a,.caption-details-inner .chart span,.caption-details-inner .chart i,#coo-slider .flex-caption-large .chart i,.woocommerce .star-rating span,.ct-super-search .search-options .ss-dropdown > span,.ct-super-search .search-options input,.ct-super-search .search-options .ss-dropdown ul li .fa-check,#coo-slider .flex-caption-large .loveit-chart span,#coo-slider .flex-caption-large a,.progress-bar-wrap .progress-value').css('color', to ? to : '' );
			$('.bypostauthor .comment-wrap .comment-avatar,a[rel="tooltip"],.ct-icon-box-animated .back').css('border-color', to ? to : '' );
			$('.spb_impact_text .spb_call_text').css('border-left-color', to ? to : '' );
			$('.ct-super-search .search-options .ss-dropdown > span,.ct-super-search .search-options input').css('border-bottom-color', to ? to : '' );
		});
	});
	
	wp.customize('accent_alt_color',function( value ) {
		value.bind(function(to) {
			$('.recent-post figure,span.highlighted,span.dropcap4,.flickr-widget li,.portfolio-grid li,.wpcf7 input.wpcf7-submit[type="submit"],.woocommerce-page nav.woocommerce-pagination ul li span.current,.woocommerce nav.woocommerce-pagination ul li span.current,figcaption .product-added,.woocommerce .wc-new-badge,.yith-wcwl-wishlistexistsbrowse a,.yith-wcwl-wishlistaddedbrowse a,.woocommerce .widget_layered_nav ul li.chosen > *,.woocommerce .widget_layered_nav_filters ul li a,.sticky-post-icon,figure.animated-overlay figcaption .thumb-info h4,figure.animated-overlay figcaption .thumb-info h5,.slideout-filter ul li a,.slideout-filter ul li.selected a,.blog-aux-options li.selected a,.ct-button.accent,.ct-button.ct-icon-reveal.accent,.ct-icon-box-animated .back,.ct-icon-box-animated .back h3,.woocommerce-page nav.woocommerce-pagination ul li span.current,.woocommerce nav.woocommerce-pagination ul li span.current,li.product figcaption a.product-added,.woocommerce .order-info,.woocommerce .order-info mark').css('color', to ? to : '' );
		});
	});
	...
	wp.customize('secondary_accent_color',function( value ) {
		value.bind(function(to) {
			...
			$('#top-bar .show-menu,#coo-slider .flex-caption .comment-chart i,#coo-slider .flex-caption .comment-chart span,.sidebar .widget_calendar tfoot a,.widget_ct_infocus_widget .infocus-item h5 a').css('color', to ? to : '' );
	...
	wp.customize('secondary_accent_alt_color',function( value ) {
		value.bind(function(to) {
			$('.show-menu,#coo-slider .flex-caption-large,#coo-slider .flex-caption-large h1 a,#coo-slider .flex-caption-large .comment-chart i,.loved-item .loved-count,.subscribers-list li > a.social-circle,.sidebar .widget_calendar tbody tr > td a').css('color', to ? to : '' );
		});
	});
	...
	wp.customize('icon_container_bg_color',function( value ) {
		value.bind(function(to) {
			$('.ct-icon-cont').css('background-color', to ? to : '' );
		});
	});		
	wp.customize('ct_icon_color',function( value ) {
		value.bind(function(to) {
			$('.ct-icon').css('color', to ? to : '' );
		});
	});
