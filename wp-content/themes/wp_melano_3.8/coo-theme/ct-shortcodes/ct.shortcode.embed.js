function embedSelectedShortcode() {
	...
	if (current_shortcode != -1) {
		...
		if (shortcode_select == 'shortcode-buttons') {
			shortcodeHTML = '[ct_button colour="'+button_colour+'" type="'+button_type+'" size="'+button_size+'" link="'+button_url+'" target="'+button_target+'" icon="'+button_icon+'" dropshadow="'+button_dropshadow+'" extraclass="'+button_extraclass+'"]'+button_text+'[/ct_button]';
		}
		...
		if (shortcode_select == 'shortcode-iconbox') {
			shortcodeHTML = '[ct_iconbox image="'+iconbox_image+'" character="'+iconbox_character+'" type="'+iconbox_type+'" title="'+iconbox_title+'" animation="'+iconbox_animation+'" animation_delay="'+iconbox_animation_delay+'"]<br/>Enter your Icon Box content here<br/>[/ct_iconbox]';
		}
		...
		if (shortcode_select == 'shortcode-imagebanner') {
			shortcodeHTML = '[ct_imagebanner image="'+imagebanner_image+'" animation="'+imagebanner_animation+'" contentpos="'+imagebanner_contentpos+'" textalign="'+imagebanner_textalign+'" extraclass="'+imagebanner_extraclass+'"]<br/>Enter your Image Banner content here<br/>[/ct_imagebanner]';
		}
		...
		if (shortcode_select == 'shortcode-counters') {
			...
			shortcodeHTML = '[ct_count from="' + count_from + '" to="' + count_to + '" speed="' + count_speed + '" refresh="' + count_refresh + '" textstyle="' + count_textstyle + '" subject="' + count_subject + '"]<br/>';
		...
		if (shortcode_select == 'shortcode-countdown') {
			...
			shortcodeHTML = '[ct_countdown year="' + countdown_year + '" month="' + countdown_month + '" day="' + countdown_day + '" fontsize="' + countdown_fontsize + '" displaytext="' + countdown_displaytext + '"]<br/>';
		...
		if (shortcode_select == 'shortcode-tooltip') {
			...
			shortcodeHTML = '[ct_tooltip link="' + tooltip_link + '" direction="' + tooltip_direction + '" title="'+ tooltip_text +'"]TEXT HERE[/ct_tooltip]';
		...
		if (shortcode_select == 'shortcode-modal') {
			...
			shortcodeHTML = '[ct_modal header="' + modal_header + '" btn_colour="'+modal_button_colour+'" btn_type="'+modal_button_type+'" btn_size="'+modal_button_size+'" btn_text="'+modal_button_text+'"]<br/>ENTER THE MODAL BODY HERE<br/>[/ct_modal]<br/>';
		...
		if (shortcode_select == 'shortcode-fwvideo') {
			...
			shortcodeHTML = '[ct_fullscreenvideo type="'+ fwvideo_type +'" btntext="'+ fwvideo_btntext +'" imageurl="'+ fwvideo_imageurl +'" videourl="'+ fwvideo_videourl +'" extraclass="'+fwvideo_extraclass+'"]<br/>';
		...
		if (shortcode_select == 'shortcode-responsivevis') {
			...
			shortcodeHTML = '[ct_visibility class="'+ responsivevis_config +'"]<br/>ENTER THE RESPONSIVE VISIBILITY CONTENT HERE<br/>[/ct_visibility]<br/>';
