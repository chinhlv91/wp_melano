...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<!-- Title & Meta -->
		<title><?php _e('Cootheme Shortcodes', 'coo-theme-admin'); ?></title>
		<meta http-equiv="Content-Type" content="<?php bloginfo('html_type'); ?>; charset=<?php echo get_option('blog_charset'); ?>" />

		<!-- LOAD scripts -->
		<script language="javascript" type="text/javascript" src="<?php echo get_option('siteurl') ?>/wp-includes/js/jquery/jquery.js"></script>
		<script language="javascript" type="text/javascript" src="<?php echo get_template_directory_uri() ?>/coo-theme/ct-shortcodes/ct.shortcodes.js"></script>
		<script language="javascript" type="text/javascript" src="<?php echo get_template_directory_uri() ?>/coo-theme/ct-shortcodes/ct.shortcode.embed.js"></script>
		...
		<link href="<?php echo get_template_directory_uri() ?>/coo-theme/ct-shortcodes/base.css" rel="stylesheet" type="text/css" />
		<link href="<?php echo get_template_directory_uri() ?>/coo-theme/ct-shortcodes/ct-shortcodes-style.css" rel="stylesheet" type="text/css" />
	...
	<body onLoad="tinyMCEPopup.executeOnLoad('init();');document.body.style.display='';" id="link" >
		...
		<!-- OPEN cootheme_shortcode_form -->
		<form name="cootheme_shortcode_form" action="#">
			...
			<div id="shortcode_wrap">
				...
				<div id="shortcode_panel" class="current">
					...
					<fieldset>
						...
						<h4><?php _e('Select a shortcode', 'coo-theme-admin'); ?></h4>
						<div class="option">
							<label for="shortcode-select"><?php _e('Shortcode', 'coo-theme-admin'); ?></label>
							<select id="shortcode-select" name="shortcode-select">
								<option value="0"></option>
								<option value="shortcode-buttons"><?php _e('Button', 'coo-theme-admin'); ?></option>
								<option value="shortcode-chart"><?php _e('Chart', 'coo-theme-admin'); ?></option>
								<option value="shortcode-columns"><?php _e('Columns', 'coo-theme-admin'); ?></option>
								<option value="shortcode-counters"><?php _e('Counters', 'coo-theme-admin'); ?></option>
								<option value="shortcode-countdown"><?php _e('Countdown', 'coo-theme-admin'); ?></option>
								<option value="shortcode-icons"><?php _e('Icons', 'coo-theme-admin'); ?></option>
								<option value="shortcode-iconbox"><?php _e('Icon Box', 'coo-theme-admin'); ?></option>
								<option value="shortcode-imagebanner"><?php _e('Image Banner', 'coo-theme-admin'); ?></option>
								<option value="shortcode-labelledpricingtables"><?php _e('Labelled Pricing Table', 'coo-theme-admin'); ?></option>
								<option value="shortcode-lists"><?php _e('Lists', 'coo-theme-admin'); ?></option>
								<option value="shortcode-modal"><?php _e('Modal', 'coo-theme-admin'); ?></option>
								<option value="shortcode-pricingtables"><?php _e('Pricing Table', 'coo-theme-admin'); ?></option>
								<option value="shortcode-progressbar"><?php _e('Progress Bar', 'coo-theme-admin'); ?></option>
								<option value="shortcode-fwvideo"><?php _e('Fullscreen Video', 'coo-theme-admin'); ?></option>
								<option value="shortcode-responsivevis"><?php _e('Responsive Visiblity', 'coo-theme-admin'); ?></option>
								<option value="shortcode-social"><?php _e('Social', 'coo-theme-admin'); ?></option>
								<option value="shortcode-social-share"><?php _e('Social share', 'coo-theme-admin'); ?></option>
								<option value="shortcode-tables"><?php _e('Table', 'coo-theme-admin'); ?></option>
								<option value="shortcode-tooltip"><?php _e('Tooltip', 'coo-theme-admin'); ?></option>
								<option value="shortcode-typography"><?php _e('Typography', 'coo-theme-admin'); ?></option>
							</select>
						</div>
						...
						<div id="shortcode-buttons">
							<h5><?php _e('Buttons', 'coo-theme-admin'); ?></h5>
							<div class="option">
								<label for="button-size"><?php _e('Button size', 'coo-theme-admin'); ?></label>
								<select id="button-size" name="button-size">
									<option value="standard"><?php _e('Standard', 'coo-theme-admin'); ?></option>
									<option value="large"><?php _e('Large', 'coo-theme-admin'); ?></option>
								</select>
							</div>
							<div class="option">
								<label for="button-colour"><?php _e('Button colour', 'coo-theme-admin'); ?></label>
								<select id="button-colour" name="button-colour">
									<option value="accent"><?php _e('Accent', 'coo-theme-admin'); ?></option>
									<option value="black"><?php _e('Black', 'coo-theme-admin'); ?></option>
									<option value="white"><?php _e('White', 'coo-theme-admin'); ?></option>
									<option value="blue"><?php _e('Blue', 'coo-theme-admin'); ?></option>
									<option value="grey"><?php _e('Grey', 'coo-theme-admin'); ?></option>
									<option value="lightgrey"><?php _e('Light Grey', 'coo-theme-admin'); ?></option>
									<option value="orange"><?php _e('Orange', 'coo-theme-admin'); ?></option>
									<option value="turquoise"><?php _e('Turquoise', 'coo-theme-admin'); ?></option>
									<option value="green"><?php _e('Green', 'coo-theme-admin'); ?></option>
									<option value="pink"><?php _e('Pink', 'coo-theme-admin'); ?></option>
									<option value="gold"><?php _e('Gold', 'coo-theme-admin'); ?></option>
									<option value="transparent-light"><?php _e('Transparent - Light (For use on images/dark backgrounds)', 'coo-theme-admin'); ?></option>
									<option value="transparent-dark"><?php _e('Transparent - Dark', 'coo-theme-admin'); ?></option>
								</select>
							</div>
							<div class="option">
								<label for="button-type"><?php _e('Button type', 'coo-theme-admin'); ?></label>
								<select id="button-type" name="button-type">
									<option value="standard"><?php _e('Standard', 'coo-theme-admin'); ?></option>
									<option value="stroke-to-fill"><?php _e('Stroke To Fill', 'coo-theme-admin'); ?></option>
									<option value="ct-icon-reveal"><?php _e('Icon Reveal', 'coo-theme-admin'); ?></option>
									<option value="ct-icon-stroke"><?php _e('Icon Stroke', 'coo-theme-admin'); ?></option>
								</select>
							</div>
							<div class="option">
								<label for="button-dropshadow" class="for-checkbox"><?php _e('Button drop shadow', 'coo-theme-admin'); ?></label>
								<input id="button-dropshadow" class="checkbox" name="button-dropshadow" type="checkbox"/>
							</div>
							<div class="option">
								<label for="button-icon"><?php _e('Button icon (for button types with icon)', 'coo-theme-admin'); ?></label>
								<input id="button-icon" name="icon-icon" type="text" value="" style="visibility: hidden;"/>
								<ul class="font-icon-grid"><?php echo $icon_list; ?></ul>
							</div>
							<div class="option">
								<label for="button-text"><?php _e('Button text', 'coo-theme-admin'); ?></label>
								<input id="button-text" name="button-text" type="text" value="<?php _e('Button text', 'coo-theme-admin'); ?>"/>
							</div>
							<div class="option">
								<label for="button-url"><?php _e('Button URL', 'coo-theme-admin'); ?></label>
								<input id="button-url" name="button-url" type="text" value="http://"/>
							</div>
							<div class="option">
								<label for="button-target" class="for-checkbox"><?php _e('Open link in a new window?', 'coo-theme-admin'); ?></label>
								<input id="button-target" class="checkbox" name="button-target" type="checkbox"/>
							</div>
							<div class="option">
								<label for="button-extraclass"><?php _e('Button Extra Class', 'coo-theme-admin'); ?></label>
						...
						<div id="shortcode-icons">
							<h5><?php _e('Icons', 'coo-theme-admin'); ?></h5>
							<div class="option">
								<label for="icon-size"><?php _e('Icon size', 'coo-theme-admin'); ?></label>
								<select id="icon-size" name="icon-size">
									<option value="small"><?php _e('Small', 'coo-theme-admin'); ?></option>
									<option value="medium"><?php _e('Medium', 'coo-theme-admin'); ?></option>
									<option value="large"><?php _e('Large', 'coo-theme-admin'); ?></option>
								</select>
							</div>
							<div class="option">
								<label for="icon-image"><?php _e('Icon image', 'coo-theme-admin'); ?></label>
								<input id="icon-image" name="icon-image" type="text" value="" style="visibility: hidden;"/>
								<ul class="font-icon-grid"><?php echo $icon_list; ?></ul>
							</div>
							<div class="option">
								<label for="icon-character"><?php _e('Icon Character', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="icon-cont"><?php _e('Circular container', 'coo-theme-admin'); ?></label>
								<select id="icon-cont" name="icon-cont">
									<option value="no"><?php _e('No', 'coo-theme-admin'); ?></option>
									<option value="yes"><?php _e('Yes', 'coo-theme-admin'); ?></option>
								</select>
							</div>
							<div class="option">
								<label for="icon-float"><?php _e('Icon float', 'coo-theme-admin'); ?></label>
								<select id="icon-float" name="icon-float">
									<option value="left"><?php _e('Left', 'coo-theme-admin'); ?></option>
									<option value="right"><?php _e('Right', 'coo-theme-admin'); ?></option>
									<option value="none"><?php _e('None', 'coo-theme-admin'); ?></option>
								</select>
							</div>
						</div>
						...
						<div id="shortcode-iconbox">
							<h5><?php _e('Icon Box', 'coo-theme-admin'); ?></h5>
							<div class="option">
								<label for="iconbox-type"><?php _e('Icon Box Type', 'coo-theme-admin'); ?></label>
								<select id="iconbox-type" name="iconbox-type">
									<option value="standard"><?php _e('Standard', 'coo-theme-admin'); ?></option>
									<option value="standard-title"><?php _e('Standard Title Icon', 'coo-theme-admin'); ?></option>
									<option value="left-icon"><?php _e('Left Icon', 'coo-theme-admin'); ?></option>
									<option value="left-icon-alt"><?php _e('Left Icon Type 2', 'coo-theme-admin'); ?></option>
									<option value="boxed-one"><?php _e('Boxed Icon Box', 'coo-theme-admin'); ?></option>
									<option value="boxed-two"><?php _e('Boxed Icon Box Type 2', 'coo-theme-admin'); ?></option>
									<option value="boxed-three"><?php _e('Boxed Icon Box Type 3', 'coo-theme-admin'); ?></option>
									<option value="boxed-four"><?php _e('Boxed Icon Box Type 4', 'coo-theme-admin'); ?></option>
									<option value="animated"><?php _e('Animated', 'coo-theme-admin'); ?></option>
								</select>
							</div>
							<div class="option">
								<label for="iconbox-image"><?php _e('Icon Box Image', 'coo-theme-admin'); ?></label>
								<input id="iconbox-image" name="iconbox-image" type="text" value="" style="visibility: hidden;"/>
								<ul class="font-icon-grid"><?php echo $icon_list; ?></ul>
							</div>
							<div class="option">
								<label for="iconbox-character"><?php _e('Icon Character', 'coo-theme-admin'); ?></label>
								<input id="iconbox-character" name="iconbox-character" type="text" value=""/>
								<p class="info">Instead of an icon, you can optionally provide a single letter/digit here. NOTE: This will override the icon selection.</p>
							</div>
							<div class="option">
								<label for="iconbox-title"><?php _e('Icon Box Title', 'coo-theme-admin'); ?></label>
								<input id="iconbox-title" name="iconbox-title" type="text" value=""/>
							</div>
							<div class="option">
								<label for="iconbox-animation"><?php _e('Icon Box Animation', 'coo-theme-admin'); ?></label>
								<select id="iconbox-animation" name="iconbox-animation">
									<option value="none"><?php _e('None', 'coo-theme-admin'); ?></option>
									<option value="fade-in"><?php _e('Fade in', 'coo-theme-admin'); ?></option>
									<option value="fade-from-left"><?php _e('Fade from left', 'coo-theme-admin'); ?></option>
									<option value="fade-from-right"><?php _e('Fade from right', 'coo-theme-admin'); ?></option>
									<option value="fade-from-bottom"><?php _e('Fade from bottom', 'coo-theme-admin'); ?></option>
									<option value="move-up"><?php _e('Move up', 'coo-theme-admin'); ?></option>
									<option value="grow"><?php _e('Grow', 'coo-theme-admin'); ?></option>
									<option value="helix"><?php _e('Helix', 'coo-theme-admin'); ?></option>
									<option value="flip"><?php _e('Flip', 'coo-theme-admin'); ?></option>
									<option value="pop-up"><?php _e('Pop up', 'coo-theme-admin'); ?></option>
									<option value="spin"><?php _e('Spin', 'coo-theme-admin'); ?></option>
									<option value="flip-x"><?php _e('Flip X', 'coo-theme-admin'); ?></option>
									<option value="flip-y"><?php _e('Flip Y', 'coo-theme-admin'); ?></option>
								</select>
							</div>
							<div class="option">
								<label for="iconbox-animation-delay"><?php _e('Icon Box Animation Delay', 'coo-theme-admin'); ?></label>
						...
						<div id="shortcode-social">
							<h5><?php _e('Social', 'coo-theme-admin'); ?></h5>
							<div class="option">
								<label for="social-size"><?php _e('Social Icon Size', 'coo-theme-admin'); ?></label>
						...
						<div id="shortcode-social-share">
							<h5><?php _e('Social share', 'coo-theme-admin'); ?></h5>
							<div class="option">
						...
						<div id="shortcode-typography">
							<h5><?php _e('Typography', 'coo-theme-admin'); ?></h5>
							<div class="option">
								<label for="typography-type"><?php _e('Type', 'coo-theme-admin'); ?></label>
								<select id="typography-type" name="typography-type">
									<option value="0"></option>
									<option value="highlight"><?php _e('Highlight', 'coo-theme-admin'); ?></option>
									<option value="decorative_ampersand"><?php _e('Decorative Ampersand', 'coo-theme-admin'); ?></option>
									<option value="blockquote1"><?php _e('Blockquote Standard', 'coo-theme-admin'); ?></option>
									<option value="blockquote2"><?php _e('Blockquote Medium', 'coo-theme-admin'); ?></option>
									<option value="blockquote3"><?php _e('Blockquote Big', 'coo-theme-admin'); ?></option>
									<option value="pullquote"><?php _e('Pull Quote', 'coo-theme-admin'); ?></option>
									<option value="dropcap1"><?php _e('Dropcap Type 1', 'coo-theme-admin'); ?></option>
									<option value="dropcap2"><?php _e('Dropcap Type 2', 'coo-theme-admin'); ?></option>
									<option value="dropcap3"><?php _e('Dropcap Type 3', 'coo-theme-admin'); ?></option>
									<option value="dropcap4"><?php _e('Dropcap Type 4', 'coo-theme-admin'); ?></option>
								</select>
							</div>
						</div>
						...
						<div id="shortcode-columns" class="shortcode-option">
							<h5><?php _e('Columns', 'coo-theme-admin'); ?></h5>
							<div class="option">
								<label for="column-options"><?php _e('Layout', 'coo-theme-admin'); ?></label>
								<select id="column-options" name="column-options">
									<option value="0"></option>
									<option value="two_halves"><?php _e('1/2 + 1/2', 'coo-theme-admin'); ?></option>
									<option value="three_thirds"><?php _e('1/3 + 1/3 + 1/3', 'coo-theme-admin'); ?></option>
									<option value="one_third_two_thirds"><?php _e('1/3 + 2/3', 'coo-theme-admin'); ?></option>
									<option value="two_thirds_one_third"><?php _e('2/3 + 1/3', 'coo-theme-admin'); ?></option>
									<option value="four_quarters"><?php _e('1/4 + 1/4 + 1/4 + 1/4', 'coo-theme-admin'); ?></option>
									<option value="one_quarter_three_quarters"><?php _e('1/4 + 3/4', 'coo-theme-admin'); ?></option>
									<option value="three_quarters_one_quarter"><?php _e('3/4 + 1/4', 'coo-theme-admin'); ?></option>
									<option value="one_quarter_one_quarter_one_half"><?php _e('1/4 + 1/4 + 1/2', 'coo-theme-admin'); ?></option>
									<option value="one_quarter_one_half_one_quarter"><?php _e('1/4 + 1/2 + 1/4', 'coo-theme-admin'); ?></option>
									<option value="one_half_one_quarter_one_quarter"><?php _e('1/2 + 1/4 + 1/4', 'coo-theme-admin'); ?></option>
								</select>
							</div>
						</div>
						...
						<div id="shortcode-progressbar" class="shortcode-option">
							<h5><?php _e('Progress Bar', 'coo-theme-admin'); ?></h5>
							<div class="option">
								<label for="progressbar-percentage"><?php _e('Percentage', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="progressbar-text"><?php _e('Progress Text', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="progressbar-value"><?php _e('Progress Value', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="progressbar-type"><?php _e('Progress Bar Type', 'coo-theme-admin'); ?></label>
								<select id="progressbar-type" name="progressbar-type">
									<option value=""><?php _e('Standard', 'coo-theme-admin'); ?></option>
									<option value="progress-striped"><?php _e('Striped', 'coo-theme-admin'); ?></option>
									<option value="progress-striped active"><?php _e('Striped - Animated', 'coo-theme-admin'); ?></option>
								</select>
							</div>
							<div class="option">
								<label for="progressbar-colour"><?php _e('Progress Bar Colour', 'coo-theme-admin'); ?></label>
						...
						<div id="shortcode-fwvideo" class="shortcode-option">
							<h5><?php _e('Fullscreen Video', 'coo-theme-admin'); ?></h5>
							<div class="option">
								<label for="fwvideo-type"><?php _e('Button type', 'coo-theme-admin'); ?></label>
								<select id="fwvideo-type" name="fwvideo-type">
									<option value="image-button"><?php _e('Image Button', 'coo-theme-admin'); ?></option>
									<option value="icon-button"><?php _e('Icon Button', 'coo-theme-admin'); ?></option>
									<option value="text-button"><?php _e('Text Button', 'coo-theme-admin'); ?></option>
								</select>
								<p class="info">Choose the button type you'd like to link to the fullscreen video.</p>
							</div>
							<div class="option">
								<label for="fwvideo-imageurl"><?php _e('Image URL (for image button)', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="fwvideo-btntext"><?php _e('Button Text (for text button)', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="fwvideo-videourl"><?php _e('Video URL', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="fwvideo-extraclass"><?php _e('Button Extra class', 'coo-theme-admin'); ?></label>
						...
						<div id="shortcode-responsivevis" class="shortcode-option">
							<h5><?php _e('Responsive Visibility', 'coo-theme-admin'); ?></h5>
							<div class="option">
								<label for="responsivevis-config"><?php _e('Device Visiblity', 'coo-theme-admin'); ?></label>
								<select id="responsivevis-config" name="responsivevis-config">
									<option value="visible-xs"><?php _e('Visible - Phone', 'coo-theme-admin'); ?></option>
									<option value="visible-md visible-sm"><?php _e('Visible - Tablet', 'coo-theme-admin'); ?></option>
									<option value="visible-lg"><?php _e('Visible - Desktop', 'coo-theme-admin'); ?></option>
									<option value="hidden-xs"><?php _e('Hidden - Phone', 'coo-theme-admin'); ?></option>
									<option value="hidden-md hidden-sm"><?php _e('Hidden - Tablet', 'coo-theme-admin'); ?></option>
									<option value="hidden-lg"><?php _e('Hidden - Desktop', 'coo-theme-admin'); ?></option>
								</select>
						...
						<div id="shortcode-tooltip" class="shortcode-option">
							<h5><?php _e('Tooltip', 'coo-theme-admin'); ?></h5>
							<div class="option">
								<label for="tooltip-text"><?php _e('Text', 'coo-theme-admin'); ?></label>
								<input id="tooltip-text" name="tooltip-text" type="text" value=''/>
								<p class="info">Enter the text for the tooltip.</p>
							</div>
							<div class="option">
								<label for="tooltip-link"><?php _e('Link', 'coo-theme-admin'); ?></label>
								<input id="tooltip-link" name="tooltip-link" type="text" value=""/>
								<p class="info">Enter the link that the tooltip text links to.</p>
							</div>
							<div class="option">
								<label for="tooltip-direction"><?php _e('Direction', 'coo-theme-admin'); ?></label>
								<select id="tooltip-direction" name="tooltip-direction">
									<option value="top"><?php _e('Top', 'coo-theme-admin'); ?></option>
									<option value="bottom"><?php _e('Bottom', 'coo-theme-admin'); ?></option>
									<option value="left"><?php _e('Left', 'coo-theme-admin'); ?></option>
									<option value="right"><?php _e('Right', 'coo-theme-admin'); ?></option>
								</select>
						...
						<div id="shortcode-modal" class="shortcode-option">
							<h5><?php _e('Modal', 'coo-theme-admin'); ?></h5>
							<div class="option">
								<label for="modal-button-size"><?php _e('Modal Button size', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="modal-button-colour"><?php _e('Modal Button colour', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="modal-button-type"><?php _e('Modal Button type', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="modal-button-text"><?php _e('Modal Button text', 'coo-theme-admin'); ?></label>
								<input id="modal-button-text" name="modal-button-text" type="text" value="<?php _e('Button text', 'coo-theme-admin'); ?>"/>
							</div>
							<div class="option">
								<label for="modal-header"><?php _e('Header', 'coo-theme-admin'); ?></label>
						...
						<div id="shortcode-chart" class="shortcode-option">
							<h5><?php _e('Chart', 'coo-theme-admin'); ?></h5>
							<div class="option">
								<label for="chart-percentage"><?php _e('Percentage', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="chart-content"><?php _e('Content', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="chart-size"><?php _e('Chart Size', 'coo-theme-admin'); ?></label>
								<select id="chart-size" name="chart-size">
									<option value="70"><?php _e('Standard', 'coo-theme-admin'); ?></option>
									<option value="170"><?php _e('Large', 'coo-theme-admin'); ?></option>
								</select>
							</div>
							<div class="option">
								<label for="chart-barcolour"><?php _e('Chart Bar Colour', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="chart-trackcolour"><?php _e('Chart Track Colour', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="chart-align"><?php _e('Chart Align', 'coo-theme-admin'); ?></label>
								<select id="chart-align" name="chart-align">
									<option value="left"><?php _e('Left', 'coo-theme-admin'); ?></option>
									<option value="center"><?php _e('Center', 'coo-theme-admin'); ?></option>
								</select>
							</div>
						</div>
						...
						<div id="shortcode-counters" class="shortcode-option">
							...
							<div class="option">
								<label for="count-speed"><?php _e('Speed', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="count-refresh"><?php _e('Refresh Interval', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="count-textstyle"><?php _e('Text style', 'coo-theme-admin'); ?></label>
								<select id="count-textstyle" name="count-textstyle">
									<option value="h3"><?php _e('H3', 'coo-theme-admin'); ?></option>
									<option value="h6"><?php _e('H6', 'coo-theme-admin'); ?></option>
									<option value="div"><?php _e('Body', 'coo-theme-admin'); ?></option>
								</select>
							</div>
						</div>
						...
						<div id="shortcode-countdown" class="shortcode-option">
							<h5><?php _e('Countdown', 'coo-theme-admin'); ?></h5>
							<div class="option">
								<label for="countdown-year"><?php _e('Year', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="countdown-month"><?php _e('Month', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="countdown-day"><?php _e('Day', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="countdown-fontsize"><?php _e('Countdown Font Size', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="countdown-displaytext"><?php _e('Display Text', 'coo-theme-admin'); ?></label>
						...
						<div id="shortcode-imagebanner" class="shortcode-option">
							<h5><?php _e('Image Banner', 'coo-theme-admin'); ?></h5>
							<div class="option">
								<label for="imagebanner-image"><?php _e('Background Image', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="imagebanner-animation"><?php _e('Content Animation', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="imagebanner-contentpos"><?php _e('Content Position', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="imagebanner-textalign"><?php _e('Text Align', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="imagebanner-extraclass"><?php _e('Extra class', 'coo-theme-admin'); ?></label>
						...
						<div id="shortcode-tables" class="shortcode-option">
							<h5><?php _e('Tables', 'coo-theme-admin'); ?></h5>
							<div class="option">
								<label for="table-type"><?php _e('Table style', 'coo-theme-admin'); ?></label>
								<select id="table-type" name="table-type">
									<option value="standard_minimal"><?php _e('Standard minimal table', 'coo-theme-admin'); ?></option>
									<option value="striped_minimal"><?php _e('Striped minimal table', 'coo-theme-admin'); ?></option>
									<option value="standard_bordered"><?php _e('Standard bordered table', 'coo-theme-admin'); ?></option>
									<option value="striped_bordered"><?php _e('Striped bordered table', 'coo-theme-admin'); ?></option>
								</select>
							</div>
							<div class="option">
								<label for="table-head"><?php _e('Table Head', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="table-columns"><?php _e('Number of columns', 'coo-theme-admin'); ?></label>
								<select id="table-columns" name="table-columns">
									<option value="1"><?php _e('1', 'coo-theme-admin'); ?></option>
									<option value="2"><?php _e('2', 'coo-theme-admin'); ?></option>
									<option value="3"><?php _e('3', 'coo-theme-admin'); ?></option>
									<option value="4"><?php _e('4', 'coo-theme-admin'); ?></option>
									<option value="5"><?php _e('5', 'coo-theme-admin'); ?></option>
									<option value="6"><?php _e('6', 'coo-theme-admin'); ?></option>
								</select>
							</div>
							
							<div class="option">
								<label for="table-rows"><?php _e('Number of rows', 'coo-theme-admin'); ?></label>
								<select id="table-rows" name="table-rows">
									...
									<option value="5"><?php _e('5', 'coo-theme-admin'); ?></option>
									<option value="6"><?php _e('6', 'coo-theme-admin'); ?></option>
									<option value="7"><?php _e('7', 'coo-theme-admin'); ?></option>
									<option value="8"><?php _e('8', 'coo-theme-admin'); ?></option>
									<option value="9"><?php _e('9', 'coo-theme-admin'); ?></option>
									<option value="10"><?php _e('10', 'coo-theme-admin'); ?></option>
								</select>
							</div>
						</div>
						...
						<div id="shortcode-pricingtables" class="shortcode-option">
							<h5><?php _e('Pricing Tables', 'coo-theme-admin'); ?></h5>
							<div class="option">
								<label for="ptable-type"><?php _e('Table style', 'coo-theme-admin'); ?></label>
								<select id="ptable-type" name="ptable-type">
									<option value="standard"><?php _e('Standard pricing table', 'coo-theme-admin'); ?></option>
									<option value="bordered"><?php _e('Bordered pricing table', 'coo-theme-admin'); ?></option>
									<option value="bordered_alt"><?php _e('Alt bordered pricing table', 'coo-theme-admin'); ?></option>
								</select>
							</div>
							<div class="option">
								<label for="ptable-columns"><?php _e('Number of columns', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="ptable-highlight"><?php _e('Highlighted column', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="ptable-buttontext"><?php _e('Button text', 'coo-theme-admin'); ?></label>
						...
						<div id="shortcode-labelledpricingtables" class="shortcode-option">
							<h5><?php _e('Labelled Pricing Table', 'coo-theme-admin'); ?></h5>
							<div class="option">
								<label for="lptable-columns"><?php _e('Number of columns', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="lptable-highlight"><?php _e('Highlighted column', 'coo-theme-admin'); ?></label>
							...
							<div class="option">
								<label for="lptable-rows"><?php _e('Number of rows', 'coo-theme-admin'); ?></label>
								<select id="lptable-rows" name="lptable-highlight">
									...
									<option value="9"><?php _e('9', 'coo-theme-admin'); ?></option>
									<option value="10"><?php _e('10', 'coo-theme-admin'); ?></option>
									<option value="11"><?php _e('11', 'coo-theme-admin'); ?></option>
									<option value="12"><?php _e('12', 'coo-theme-admin'); ?></option>
									<option value="13"><?php _e('13', 'coo-theme-admin'); ?></option>
									<option value="14"><?php _e('14', 'coo-theme-admin'); ?></option>
									<option value="15"><?php _e('15', 'coo-theme-admin'); ?></option>
									<option value="16"><?php _e('16', 'coo-theme-admin'); ?></option>
									<option value="17"><?php _e('17', 'coo-theme-admin'); ?></option>
									<option value="18"><?php _e('18', 'coo-theme-admin'); ?></option>
									<option value="19"><?php _e('19', 'coo-theme-admin'); ?></option>
									<option value="20"><?php _e('20', 'coo-theme-admin'); ?></option>
									<option value="21"><?php _e('21', 'coo-theme-admin'); ?></option>
									<option value="22"><?php _e('22', 'coo-theme-admin'); ?></option>
									<option value="23"><?php _e('23', 'coo-theme-admin'); ?></option>
									<option value="24"><?php _e('24', 'coo-theme-admin'); ?></option>
									<option value="25"><?php _e('25', 'coo-theme-admin'); ?></option>
									<option value="26"><?php _e('26', 'coo-theme-admin'); ?></option>
									<option value="27"><?php _e('27', 'coo-theme-admin'); ?></option>
									<option value="28"><?php _e('28', 'coo-theme-admin'); ?></option>
									<option value="29"><?php _e('29', 'coo-theme-admin'); ?></option>
									<option value="30"><?php _e('30', 'coo-theme-admin'); ?></option>
								</select>
							</div>
							<div class="option">
								<label for="lptable-buttontext"><?php _e('Button text', 'coo-theme-admin'); ?></label>
						...
						<div id="shortcode-lists" class="shortcode-option">
							<h5><?php _e('Lists', 'coo-theme-admin'); ?></h5>
							<div class="option">
								<label for="list-icon"><?php _e('List icon', 'coo-theme-admin'); ?></label>
								<input id="list-icon" name="list-icon" type="text" value="" style="visibility: hidden;"/>
								<ul class="font-icon-grid"><?php echo $icon_list; ?></ul>
							</div>
							<div class="option">
								<label for="list-items"><?php _e('Number of list items', 'coo-theme-admin'); ?></label>
				...
				<div class="buttons clearfix">
					<input type="submit" id="insert" name="insert" value="<?php _e('Insert Shortcode', 'coo-theme-admin'); ?>" onClick="embedSelectedShortcode();" />
				</div>

			<!-- CLOSE #shortcode_wrap -->
			</div>

		<!-- CLOSE cootheme_shortcode_form -->
		</form>
