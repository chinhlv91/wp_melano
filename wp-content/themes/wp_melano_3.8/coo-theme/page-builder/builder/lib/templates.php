<?php
	...
	/*
	*
	*	Coo Page Builder - Templates Return Class
	*	------------------------------------------------
	*	Cootheme
	...
	*/
	...
	function get_prebuilt_template_code($template_id) {
		...
		if ($template_id == "ct-home") {
			...
			[ct_iconbox image='ss-like' type='standard' title='Powerful yet simple' animation='pop-up' animation_delay='200'] Built for all levels of expertise, whether you need simple pages or complex ones, creating something incredible with Coo is an effortless and intuitive process.[/ct_iconbox]
			
			[/spb_text_block] [spb_text_block pb_margin_bottom='no' pb_border_bottom='no' width='1/3']
			
			[ct_iconbox image='ss-view' type='standard' title='Next-level features' animation='pop-up' animation_delay='400'] Coo comes packed with exciting &amp; unique features. Including full-screen native video, stunning fonts &amp; icons and a myriad of slick elements and animations.[/ct_iconbox]
			
			[/spb_text_block] [spb_text_block pb_margin_bottom='no' pb_border_bottom='no' width='1/3' el_position='last']
			
			[ct_iconbox image='ss-man' type='standard' title='Fit for any purpose' animation='pop-up' animation_delay='600']Create anything; with 7 header types, 7 Portfolio layouts, 10 Blog layouts, lots of beautifully crafted standard pages, &amp; our robust page builder packing 44 elements.[/ct_iconbox]
			...
			<p style='text-align: center;'>[ct_button colour='transparent-dark' type='ct-icon-stroke' size='medium' link='/portfolio-one-column-standard-style/portfolio-three-standard/' target='_self' icon='ss-layergroup' dropshadow='no' extraclass='']VIEW ALL PROJECTS[/ct_button]</p>
			...
			[ct_count from='0' to='301873' speed='1000' refresh='25' textstyle='h6' subject='Pixels pushed.']
			...
			[ct_count from='0' to='1448' speed='1500' refresh='25' textstyle='h6' subject='Cups of coffee consumed.']
			
			[/spb_text_block] [spb_text_block pb_margin_bottom='no' pb_border_bottom='no' el_class='mt0 pt0' width='1/4']
			<p style='text-align: center;'>[icon image='ss-pizza' character='' size='medium' cont='no' float='none']</p>
			[ct_count from='0' to='265' speed='2000' refresh='25' textstyle='h6' subject='Pizza's eaten.']
			...
			[ct_count from='0' to='95999' speed='2500' refresh='25' textstyle='h6' subject='Lines of code written.']
			
			[/spb_text_block] [blank_spacer height='46px' width='1/1' el_position='first last'] [spb_parallax parallax_type='video' bg_image='11555' bg_type='cover' bg_video_mp4='http://cootheme.com/wp-content/uploads/2013/10/crafted_600_b_med.mp4' parallax_video_height='content-height' parallax_video_overlay='none' parallax_image_height='content-height' alt_background='none' el_class='bt0 bb0 mt0 mb0 no-shadow' width='1/1' el_position='first last']
			...
			&nbsp;
			<p style='text-align: center;'>[ct_button colour='transparent-light' type='stroke-to-fill' size='large' link='/features/' target='_self' icon='' dropshadow='no' extraclass='']TELL ME MORE[/ct_button]</p>
			...
			<p class='impact-text'><span style='color: #999999;'>A few things about Coo...</span></p>
			&nbsp;
			
			[ct_iconbox image='' character='1' type='left-icon' title='It's Mobile Ready' animation='fade-from-left' animation_delay='0']
			...
			[ct_iconbox image='' character='2' type='left-icon' title='It's Retina-Ready' animation='fade-from-left' animation_delay='200']
			Designed &amp; built to look beautiful on any display, it's twice as nice on a retina device!
			[/ct_iconbox]
			
			&nbsp;
			
			[ct_iconbox image='' character='3' type='left-icon' title='It's Well Supported' animation='fade-from-left' animation_delay='400']
			...
			<p style='text-align: center;'>[ct_fullscreenvideo type='icon-button' btntext='' imageurl='' videourl='http://vimeo.com/35396305']</p>
			<p class='impact-text-large' style='text-align: center;'><span style='color: #ffffff;'>Full-screen video.</span></p>
			
			<h3 class='impact-text-large' style='text-align: center;'><span style='color: #ffffff;'>Coo supports native video playback for parallax backgrounds,</span>
			<span style='color: #ffffff;'> and it also allows you to play your videos full-screen.</span></h3>
			[hr]
			<p style='text-align: center;'>[ct_button colour='transparent-light' type='stroke-to-fill' size='large' link='/pages/about/' target='_self' icon='' dropshadow='no' extraclass='']ABOUT OUR COMPANY[/ct_button][ct_button colour='transparent-light' type='stroke-to-fill' size='large' link='/pages/contact/' target='_self' icon='' dropshadow='no' extraclass='']SAY HELLO[/ct_button]</p>
			[/spb_parallax] [fullwidth_text alt_background='alt-ten' el_class='mt0 mb0 bt0 bb0 no-shadow' width='1/1' el_position='first last']
			<h1 style='text-align: center;'>A few of Coo's core features</h1>
			...
			[ct_iconbox image='ss-mouse' character='' type='left-icon-alt' title='Gizmo icons worth $50!' animation='fade-in' animation_delay='0']
			...
			[ct_iconbox image='ss-rows' character='' type='left-icon-alt' title='7 header layouts' animation='fade-in' animation_delay='600']
			Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nulla nunc dui, tristique in semper vel.
			[/ct_iconbox]
			
			&nbsp;
			
			[ct_iconbox image='ss-layergroup' character='' type='left-icon-alt' title='Premium sliders' animation='fade-in' animation_delay='1200']
			Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nulla nunc dui, tristique in semper vel.
			...
			[ct_iconbox image='ss-globe' character='' type='left-icon-alt' title='100% Translatable' animation='fade-in' animation_delay='200']
			Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nulla nunc dui, tristique in semper vel.
			[/ct_iconbox]
			
			&nbsp;
			
			[ct_iconbox image='ss-cart' character='' type='left-icon-alt' title='Full shop functionality' animation='fade-in' animation_delay='800']
			Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nulla nunc dui, tristique in semper vel.
			[/ct_iconbox]
			
			&nbsp;
			
			[ct_iconbox image='ss-write' character='' type='left-icon-alt' title='Coo Page Builder' animation='fade-in' animation_delay='1400']
			Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nulla nunc dui, tristique in semper vel.
			...
			[ct_iconbox image='ss-columns' character='' type='left-icon-alt' title='Mega menu' animation='fade-in' animation_delay='400']
			Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nulla nunc dui, tristique in semper vel.
			[/ct_iconbox]
			
			&nbsp;
			
			[ct_iconbox image='ss-newspaper' character='' type='left-icon-alt' title='10 blog layouts' animation='fade-in' animation_delay='1000']
			Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nulla nunc dui, tristique in semper vel.
			[/ct_iconbox]
			
			&nbsp;
			
			[ct_iconbox image='ss-picture' character='' type='left-icon-alt' title='7 portfolio layouts' animation='fade-in' animation_delay='1600']
			Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nulla nunc dui, tristique in semper vel.
			...
			[hr]
			<p style='text-align: center;'>[ct_button colour='gold' type='ct-icon-reveal' size='standard' link='/features/' target='_self' icon='ss-pointright' dropshadow='no' extraclass='']TAKE THE TOUR TO FIND OUT MORE[/ct_button]</p>
			...
			[ct_button colour='accent' type='ct-icon-reveal' size='standard' link='/pages/meet-the-team/' target='_self' icon='ss-users' dropshadow='no' extraclass='ml0']FIND OUT MORE ABOUT US[/ct_button]
			...
			[ct_iconbox image='ss-signpost' character='' type='animated' title='Fully Documented' animation='none' animation_delay='200']
			Whether you're the kind of person who reads instruction manuals or not, we've written one that explains all of Coo's capabilities in intimate detail.
			[/ct_iconbox]
			
			[/spb_text_block] [spb_text_block pb_margin_bottom='no' pb_border_bottom='no' el_class='mt0 pt0' width='1/4']
			
			[ct_iconbox image='ss-lightning' character='' type='animated' title='Lightning Quick' animation='none' animation_delay='200']Coo has been built to be incredibly rapid. The lightning quick Cootheme has been optimised from the ground up, which means it's loved by users &amp; search engines alike.[/ct_iconbox]
			
			[/spb_text_block] [spb_text_block pb_margin_bottom='no' pb_border_bottom='no' el_class='mt0 pt0' width='1/4']
			
			[ct_iconbox image='ss-video' character='' type='animated' title='Tutorial Videos' animation='none' animation_delay='200']
			We've created a number of video tutorials to guide you through the finer points of how to get the best out of Coo.
			[/ct_iconbox]
			
			[/spb_text_block] [spb_text_block pb_margin_bottom='no' pb_border_bottom='no' el_class='mt0 pt0' width='1/4' el_position='last']
			
			[ct_iconbox image='ss-stopwatch' character='' type='animated' title='Quick &amp; Easy' animation='none' animation_delay='200']
		...
		} else if ($template_id == "ct-home-2") {
		
			$template_code = "[blank_spacer height='70px' width='1/1' el_position='first last'] [spb_text_block pb_margin_bottom='no' pb_border_bottom='no' width='1/3' el_position='first']
			
			[ct_iconbox image='ss-like' type='left-icon' title='Powerful yet simple' animation='fade-in' animation_delay='200']Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nulla nunc dui, tristique in semper vel.[/ct_iconbox]
			
			[/spb_text_block] [spb_text_block pb_margin_bottom='no' pb_border_bottom='no' width='1/3']
			
			[ct_iconbox image='ss-view' type='left-icon' title='Next-level features' animation='fade-in' animation_delay='400']Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nulla nunc dui, tristique in semper vel.[/ct_iconbox]
			
			[/spb_text_block] [spb_text_block pb_margin_bottom='no' pb_border_bottom='no' width='1/3' el_position='last']
			
			[ct_iconbox image='ss-man' type='left-icon' title='Fit for any purpose' animation='fade-in' animation_delay='600']Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nulla nunc dui, tristique in semper vel.[/ct_iconbox]
			...
			[ct_iconbox image='ss-chat' type='left-icon' title='Free Support &amp; updates' animation='fade-in' animation_delay='800']Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nulla nunc dui, tristique in semper vel.[/ct_iconbox]
			
			[/spb_text_block] [spb_text_block pb_margin_bottom='no' pb_border_bottom='no' width='1/3']
			
			[ct_iconbox image='ss-hand' type='left-icon' title='Gizmo icons worth $50!' animation='fade-in' animation_delay='1000']Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nulla nunc dui, tristique in semper vel.
			[/ct_iconbox]
			
			[/spb_text_block] [spb_text_block pb_margin_bottom='no' pb_border_bottom='no' width='1/3' el_position='last']
			
			[ct_iconbox image='ss-write' type='left-icon' title='Coo Page Builder' animation='fade-in' animation_delay='1200']Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nulla nunc dui, tristique in semper vel.[/ct_iconbox]
			
			[/spb_text_block] [blank_spacer height='20px' width='1/1' el_position='first last'] [spb_parallax parallax_type='video' bg_image='11555' bg_type='cover' bg_video_mp4='http://cootheme.com/wp-content/uploads/2013/10/crafted_600p.mp4' bg_video_webm='http://cootheme.com/wp-content/uploads/2013/10/crafted_600p.webmhd.webm' bg_video_ogg='http://cootheme.com/wp-content/uploads/2013/10/crafted_600p.ogv' parallax_video_height='content-height' parallax_video_overlay='none' parallax_image_height='content-height' alt_background='none' el_class='bt0 bb0 no-shadow' width='1/1' el_position='first last']
			<p class='impact-text-large' style='text-align: center;'><span style='color: #ffffff;'>Beautifully crafted with technical excellence</span>
			<span style='color: #ffffff;'> and exceptional attention to detail.</span></p>
			&nbsp;
			<p style='text-align: center;'>[ct_button colour='white' type='standard' size='standard' link='/features/' target='_self' icon='' dropshadow='no' extraclass='']TELL ME MORE[/ct_button]  [ct_button colour='transparent-light' type='standard' size='standard' link='http://' target='_self' icon='' dropshadow='no' extraclass='']BUY NOW[/ct_button]</p>
			...
			<p style='text-align: center;'>[ct_button colour='accent' type='ct-icon-reveal' size='standard' link='/portfolio-one-column-standard-style/portfolio-three-gallery/' target='_self' icon='ss-view' dropshadow='no' extraclass='']VIEW OUR PORTFOLIO[/ct_button]</p>
			[/fullwidth_text] [blank_spacer height='40px' width='1/1' el_position='first last'] [clients_featured title='Selected Client List:' category='featured' alt_background='alt-four' el_class='mt0 mb0 bt0 bb0' width='1/1' el_position='first last'] [spb_parallax parallax_type='video' bg_image='11561' bg_type='cover' bg_video_mp4='http://cootheme.com/wp-content/uploads/2013/10/stars_600p.mp4' bg_video_webm='http://cootheme.com/wp-content/uploads/2013/10/stars_600p.webmhd.webm' bg_video_ogg='http://cootheme.com/wp-content/uploads/2013/10/stars_600p.ogv' parallax_video_height='content-height' parallax_video_overlay='none' parallax_image_height='content-height' alt_background='none' el_class='bt0 bb0 mt0 mb0' width='1/1' el_position='first last']
			
			[one_third]
			
			[ct_iconbox image='ss-mouse' character='' type='boxed-one' title='Gizmo Icons worth $50!' animation='grow' animation_delay='0']
			Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nulla nunc dui, tristique in semper vel.
			[/ct_iconbox]
			...
			[ct_iconbox image='ss-layergroup' character='' type='boxed-one' title='Premium Sliders' animation='grow' animation_delay='200']
			Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nulla nunc dui, tristique in semper vel.
			[/ct_iconbox]
			...
			[ct_iconbox image='ss-globe' character='' type='boxed-one' title='100% Translatable' animation='grow' animation_delay='400']
			Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nulla nunc dui, tristique in semper vel.
			[/ct_iconbox]
			...
			[ct_button colour='accent' type='ct-icon-reveal' size='standard' link='/blog-timeline-full-width/blog-masonry-effect-four/' target='_self' icon='ss-file' dropshadow='no' extraclass='']READ MORE ARTICLES[/ct_button]
			...
			<p style='text-align: center;'>Showing off your work has never been easier or more fun. Coo has 10 different
			...
			<p style='text-align: center;'>[ct_button colour='accent' type='ct-icon-reveal' size='large' link='/portfolio-one-column-standard-style/portfolio-three-standard/' target='_self' icon='ss-view' dropshadow='no' extraclass='']SEE MORE OF OUR WORK[/ct_button]</p>
			...
			[one_third]
			<p style='text-align: center;'><img class='alignnone size-full wp-image-11424' alt='about_3_col_icons_trans3' src='http://cootheme.com/wp-content/uploads/2013/06/about_3_col_icons_trans3.png' width='100' height='98' /></p>
			...
			<p style='text-align: center;'>[ct_button colour='white' type='ct-icon-reveal' size='standard' link='/pages/about/' target='_self' icon='ss-user' dropshadow='yes' extraclass='']ABOUT[/ct_button]</p>
			[/one_third]
			
			[one_third]
			<p style='text-align: center;'><img class='alignnone size-full wp-image-11425' alt='about_3_col_icons_trans2' src='http://cootheme.com/wp-content/uploads/2013/06/about_3_col_icons_trans2.png' width='100' height='98' /></p>
			
			<h3 style='text-align: center;'>Creativity</h3>
			[hr]
			<p style='text-align: center;'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse viverra mauris eget tortor imperdiet vehicula. Proin egestas diam ac mauris molestie hendrerit.</p>
			<p style='text-align: center;'>[ct_button colour='white' type='ct-icon-reveal' size='standard' link='/pages/services/' target='_self' icon='ss-write' dropshadow='yes' extraclass='']SERVICES[/ct_button]</p>
			[/one_third]
			
			[one_third_last]
			<p style='text-align: center;'><img class='alignnone size-full wp-image-11426' alt='about_3_col_icons_trans' src='http://cootheme.com/wp-content/uploads/2013/06/about_3_col_icons_trans.png' width='100' height='98' /></p>
			
			<h3 style='text-align: center;'>Technology</h3>
			[hr]
			<p style='text-align: center;'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse viverra mauris eget tortor imperdiet vehicula. Proin egestas diam ac mauris molestie hendrerit.</p>
			<p style='text-align: center;'>[ct_button colour='white' type='ct-icon-reveal' size='standard' link='http://cootheme.com/careers/' target='_self' icon='ss-man' dropshadow='yes' extraclass='']CAREERS[/ct_button]</p>
			[/one_third_last]
			...
			[ct_iconbox image='ss-mouse' character='' type='left-icon-alt' title='Gizmo icons worth $50!' animation='fade-from-left' animation_delay='0']
			...
			[ct_iconbox image='ss-rows' character='' type='left-icon-alt' title='7 header layouts' animation='fade-from-left' animation_delay='600']
			...
			[ct_iconbox image='ss-globe' character='' type='left-icon-alt' title='100% Translatable' animation='fade-from-bottom' animation_delay='200']
			...
			[ct_iconbox image='ss-cart' character='' type='left-icon-alt' title='Full shop functionality' animation='fade-from-bottom' animation_delay='800']
			...
			[ct_iconbox image='ss-columns' character='' type='left-icon-alt' title='Mega menu' animation='fade-from-right' animation_delay='400']
			...
			[ct_iconbox image='ss-newspaper' character='' type='left-icon-alt' title='10 blog layouts' animation='fade-from-right' animation_delay='1000']
			...
			[ct_button colour='transparent-dark' type='standard' size='standard' link='/pages/about/' target='_self' icon='' dropshadow='no' extraclass='']ABOUT OUR COMPANY[/ct_button]
			...
			[ct_button colour='transparent-dark' type='standard' size='standard' link='/pages/services/' target='_self' icon='' dropshadow='no' extraclass='']OUR SERVICES[/ct_button]
			...
			[/spb_parallax] [blank_spacer height='34px' width='1/1' el_position='first last'] [ct_gallery gallery_id='11099' slider_transition='slide' show_captions='yes' width='1/2' el_position='first'] [spb_accordion active_section='0' width='1/2' el_position='last'] [spb_accordion_tab title='Section One'] [spb_text_block pb_margin_bottom='no' pb_border_bottom='no' el_class='mb0 pb0' width='1/1' el_position='first last']
			...
			[/spb_text_block] [recent_posts item_columns='3' item_count='3' category='All' excerpt_length='23' width='1/1' el_position='first last'] [blank_spacer height='60px' width='1/1' el_position='first last'] [spb_parallax parallax_type='video' bg_image='11555' bg_type='cover' bg_video_mp4='http://cootheme.com/wp-content/uploads/2013/10/crafted_600p.mp4' bg_video_webm='http://cootheme.com/wp-content/uploads/2013/10/crafted_600p.webmhd.webm' bg_video_ogg='http://cootheme.com/wp-content/uploads/2013/10/crafted_600p.ogv' parallax_video_height='content-height' parallax_video_overlay='none' parallax_image_height='content-height' alt_background='none' el_class='mt0 bt0 mb0 bb0' width='1/1' el_position='first last']
			...
			[ct_iconbox image='' character='1' type='standard' title='Brief' animation='pop-up' animation_delay='0'] Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nulla nunc dui, tristique in semper vel.[/ct_iconbox]
			
			[/spb_text_block] [spb_text_block pb_margin_bottom='no' pb_border_bottom='no' width='1/4']
			
			[ct_iconbox image='' character='2' type='standard' title='Analysis' animation='pop-up' animation_delay='200']Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nulla nunc dui, tristique in semper vel.[/ct_iconbox]
			
			[/spb_text_block] [spb_text_block pb_margin_bottom='no' pb_border_bottom='no' width='1/4']
			
			[ct_iconbox image='' character='3' type='standard' title='Planning' animation='pop-up' animation_delay='400']Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nulla nunc dui, tristique in semper vel.[/ct_iconbox]
			
			[/spb_text_block] [spb_text_block pb_margin_bottom='no' pb_border_bottom='no' width='1/4' el_position='last']
			
			[ct_iconbox image='' character='4' type='standard' title='Execution' animation='pop-up' animation_delay='600']Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nulla nunc dui, tristique in semper vel.[/ct_iconbox]
			...
			[ct_iconbox image='ss-share' character='' type='animated' title='Strategy' animation='none' animation_delay='200']
			...
			[ct_iconbox image='ss-smartphone' character='' type='animated' title='Mobile' animation='none' animation_delay='200']
			Suspendisse bibendum cursus luctus. Donec consequat malesuada felis at faucibus. Nulla dapibus malesuada libero, ut iaculis elit mattis quis. Sed nec dui tortor, ut venenatis libero.
			[/ct_iconbox]
			...
			[ct_iconbox image='ss-mouse' character='' type='animated' title='Technology' animation='none' animation_delay='200']
			Suspendisse bibendum cursus luctus. Donec consequat malesuada felis at faucibus. Nulla dapibus malesuada libero, ut iaculis elit mattis quis. Sed nec dui tortor, ut venenatis libero.
			[/ct_iconbox]
			
			&nbsp;
			
			[ct_iconbox image='ss-usergroup' character='' type='animated' title='Marketing' animation='none' animation_delay='200']
			Suspendisse bibendum cursus luctus. Donec consequat malesuada felis at faucibus. Nulla dapibus malesuada libero, ut iaculis elit mattis quis. Sed nec dui tortor, ut venenatis libero.
			[/ct_iconbox]
			...
			[ct_iconbox image='ss-video' character='' type='animated' title='Motion' animation='none' animation_delay='200']
			Suspendisse bibendum cursus luctus. Donec consequat malesuada felis at faucibus. Nulla dapibus malesuada libero, ut iaculis elit mattis quis. Sed nec dui tortor, ut venenatis libero.
			[/ct_iconbox]
			
			&nbsp;
			
			[ct_iconbox image='ss-piechart' character='' type='animated' title='Analytics' animation='none' animation_delay='200']
			Suspendisse bibendum cursus luctus. Donec consequat malesuada felis at faucibus. Nulla dapibus malesuada libero, ut iaculis elit mattis quis. Sed nec dui tortor, ut venenatis libero.
			[/ct_iconbox]
			...
			[ct_iconbox image='ss-chat' character='' type='animated' title='Social' animation='none' animation_delay='200']
			Suspendisse bibendum cursus luctus. Donec consequat malesuada felis at faucibus. Nulla dapibus malesuada libero, ut iaculis elit mattis quis. Sed nec dui tortor, ut venenatis libero.
			[/ct_iconbox]
			
			&nbsp;
			
			[ct_iconbox image='ss-bezier' character='' type='animated' title='Design &amp; UX' animation='none' animation_delay='200']
			Suspendisse bibendum cursus luctus. Donec consequat malesuada felis at faucibus. Nulla dapibus malesuada libero, ut iaculis elit mattis quis. Sed nec dui tortor, ut venenatis libero.
			[/ct_iconbox]
			...
			</a>Twitter: <a href='https://twitter.com/cootheme'>@cootheme
			...
			[ct_iconbox image='ss-like' type='standard-title' title='Powerful yet simple' animation='fade-from-bottom' animation_delay='200'] Built for all levels of expertise, whether you need simple pages or complex ones, creating something incredible with Coo is an effortless and intuitive process.[/ct_iconbox]
			
			[/spb_text_block] [spb_text_block pb_margin_bottom='no' pb_border_bottom='no' width='1/4']
			
			[ct_iconbox image='ss-view' type='standard-title' title='Next-level features' animation='fade-from-bottom' animation_delay='400'] Coo comes packed with exciting &amp; unique features. Including full-screen native video, stunning fonts &amp; icons and lots of slick elements &amp; animations.[/ct_iconbox]
			
			[/spb_text_block] [spb_text_block pb_margin_bottom='no' pb_border_bottom='no' width='1/4']
			
			[ct_iconbox image='ss-man' type='standard-title' title='Fit for any purpose' animation='fade-from-bottom' animation_delay='600']Create anything; with 7 header types, 7 Portfolio layouts, 10 Blog layouts, lots of beautifully crafted standard pages, &amp; our robust page builder packing 44 elements.[/ct_iconbox]
			
			[/spb_text_block] [spb_text_block pb_margin_bottom='no' pb_border_bottom='no' width='1/4' el_position='last']
			
			[ct_iconbox image='ss-chat' type='standard-title' title='Free Support &amp; updates' animation='fade-from-bottom' animation_delay='800']Our experienced support team prides itself on quick response times. Whatever your level of expertise, we're here to help you with any questions you might have.[/ct_iconbox]
			...
			<h1 class='mt0 mb0'>Coo has been painstakingly crafted with technical
		...
		} else if ($template_id == "ct-home-7") {
		
			$template_code = "[fullwidth_text alt_background='alt-four' el_class='bt0 bb0 mb0 mt0 no-arrow' width='1/1' el_position='first last']
			
			[ct_countdown year='2014' month='4' day='13' fontsize='large' displaytext='Until our amazing sale begins!']
			
			[/fullwidth_text] [blank_spacer height='70px' width='1/1' el_position='first last'] [spb_products title='New Arrivals' asset_type='latest-products' carousel='yes' product_size='standard' item_count='6' width='1/1' el_position='first last'] [blank_spacer height='72px' width='1/1' el_position='first last'] [supersearch el_class='mt0 mb0 bt0 bb0' width='1/1' el_position='first last'] [blank_spacer height='66px' width='1/1' el_position='first last'] [spb_products_mini title='Best Sellers' asset_type='best-sellers' item_count='3' width='1/4' el_position='first'] [spb_products_mini title='Top Rated' asset_type='top-rated' item_count='3' width='1/4'] [spb_products_mini title='Sale Items' asset_type='sale-products' item_count='3' width='1/4'] [posts_carousel title='Latest Articles' item_count='2' category='All' show_title='yes' show_excerpt='yes' show_details='no' excerpt_length='12' width='1/4' el_position='last'] [blank_spacer height='26px' width='1/1' el_position='first last'] [tweets_slider title='Tweets from the shop floor' twitter_username='@cootheme' text_size='large' tweets_count='6' autoplay='yes' alt_background='alt-four' el_class='mb0 bt0 bb0' width='1/1' el_position='first last']";
			
		} else if ($template_id == "ct-home-8") {
		
			$template_code = "[spb_parallax parallax_type='video' bg_image='11558' bg_type='cover' bg_video_mp4='http://cootheme.com/wp-content/uploads/2013/10/crafted_1080p1.mp4' bg_video_webm='http://cootheme.com/wp-content/uploads/2013/10/crafted_1080p.webmhd.webm' bg_video_ogg='http://cootheme.com/wp-content/uploads/2013/10/crafted_1080p.ogv' parallax_video_height='video-height' parallax_video_overlay='none' parallax_image_height='content-height' alt_background='none' el_class='mt0 bt0 mb0 bb0' width='1/1' el_position='first last']
			...
			<p style='text-align: center;'><span style='color: #ffffff;'>[hr]</span></p>
			<p style='text-align: center;'><span style='color: #ffffff;'>[ct_button colour='transparent-light' type='standard' size='large' link='/features/' target='_self' icon='' dropshadow='no' extraclass='']TELL ME MORE[/ct_button]</span></p>
			&nbsp;
			...
			&nbsp;
			<p style='text-align: center;'>[ct_fullscreenvideo type='icon-button' btntext='' imageurl='' videourl='http://vimeo.com/35396305' extraclass='']</p>
			...
			[ct_button colour='white' type='ct-icon-stroke' size='large' link='http://' target='_self' icon='ss-barchart' dropshadow='no' extraclass='']SEE OUR STATISTICS[/ct_button]
			
			[/spb_text_block] [fullwidth_text alt_background='none' el_class='mt0 pt0 mb0 pb0' width='1/4' el_position='last']
			
			[ct_iconbox image='ss-users' character='' type='standard' title='50 People' animation='fade-from-bottom' animation_delay='0']
			[/ct_iconbox]
			
			[ct_iconbox image='ss-location' character='' type='standard' title='5 Locations' animation='fade-from-bottom' animation_delay='400']
			[/ct_iconbox]
			
			[ct_iconbox image='ss-lightbulb' character='' type='standard' title='Infinite Ideas' animation='fade-from-bottom' animation_delay='800']
			[/ct_iconbox]
			...
			[one_third]
			[ct_iconbox image='' character='1' type='boxed-two' title='Clients become friends' animation='pop-up' animation_delay='0']
			...
			[/one_third]
			[one_third]
			[ct_iconbox image='' character='2' type='boxed-two' title='We're 100% Independent' animation='pop-up' animation_delay='200']
			Vestibulum ante ipsum primis in fauc ibus orci luctus et ultrices posuere cubilia Curae; Integer in enim dui. Suspendisse potenti. Sed placerat.
			[/ct_iconbox]
			
			[/one_third]
			[one_third_last]
			[ct_iconbox image='' character='3' type='boxed-two' title='We know how to party' animation='pop-up' animation_delay='400']
			Vestibulum ante ipsum primis in fauc ibus orci luctus et ultrices posuere cubilia Curae; Integer in enim dui. Suspendisse potenti. Sed placerat.
			[/ct_iconbox]
			[/one_third_last]
			[one_third]
			
			[ct_iconbox image='' character='4' type='boxed-two' title='We're diligent' animation='pop-up' animation_delay='600']Vestibulum ante ipsum primis in fauc ibus orci luctus et ultrices posuere cubilia Curae; Integer in enim dui. Suspendisse potenti. Sed placerat.
			
			[/ct_iconbox]
			[/one_third]
			[one_third]
			[ct_iconbox image='' character='5' type='boxed-two' title='We're talented' animation='pop-up' animation_delay='800']Vestibulum ante ipsum primis in fauc ibus orci luctus et ultrices posuere cubilia Curae; Integer in enim dui. Suspendisse potenti. Sed placerat.
			
			[/ct_iconbox]
			[/one_third]
			[one_third_last]
			[ct_iconbox image='' character='6' type='boxed-two' title='We intelligent' animation='pop-up' animation_delay='1000']Vestibulum ante ipsum primis in fauc ibus orci luctus et ultrices posuere cubilia Curae; Integer in enim dui. Suspendisse potenti. Sed placerat.
			...
			[ct_countdown year='2014' month='1' day='24' fontsize='large' displaytext='Until our team releases our next project.']
			...
			<h1 style='text-align: center;'>We are Coo</h1>
		...
		} else if ($template_id == "ct-about-2") {
		
			$template_code = "[blank_spacer height='80px' width='1/1' el_position='first last'] [ct_gallery gallery_id='11099' slider_transition='slide' show_captions='yes' width='1/2' el_position='first'] [spb_text_block title='Welcome to Coo' pb_margin_bottom='no' pb_border_bottom='no' width='1/2' el_position='last']
		...
		} else if ($template_id == "ct-careers") {
			...
			[ct_fullscreenvideo type='image-button' btntext='' imageurl='http://cootheme.com/wp-content/uploads/2013/10/coo_career_video_1d.jpg' videourl='http://vimeo.com/35396305' extraclass='']
			<h3>Oliver Matthews
			...
			[ct_fullscreenvideo type='image-button' btntext='' imageurl='http://cootheme.com/wp-content/uploads/2013/10/coo_career_video_2.jpg' videourl='http://vimeo.com/35396305' extraclass='']
			<h3>Claire Cosgrove
			...
			[ct_fullscreenvideo type='image-button' btntext='' imageurl='http://cootheme.com/wp-content/uploads/2013/10/coo_career_video_3.jpg' videourl='http://vimeo.com/35396305' extraclass='']
			<h3>Melissa Munari
		...
		} else if ($template_id == "ct-contact") {
			...
			<h3>Contact details</h3>
			Email: <a href='#' target='_blank'>youremail@yourdomain.com
			</a>Twitter: <a href='https://twitter.com/cootheme'>@cootheme</a>
		...
		} else if ($template_id == "ct-contact-2") {
			...
			[ct_iconbox image='ss-chat' character='' type='boxed-three' title='Live chat' animation='pop-up' animation_delay='200']
			...
			[ct_iconbox image='ss-mail' character='' type='boxed-three' title='Email Us' animation='pop-up' animation_delay='600']
			...
			[ct_iconbox image='ss-phone' character='' type='boxed-three' title='Call Us' animation='pop-up' animation_delay='1000']
		...
		} else if ($template_id == "ct-delivery") {
		
			$template_code = "[spb_text_block pb_margin_bottom='no' pb_border_bottom='no' width='1/2' el_position='first']
			<h3>Coo maintains full ownership of the products until full payment has been obtained.</h3>
			...
			<p class='impact-text'>Coo has been painstakingly crafted with technical
			excellence and exceptional attention to detail.</p>
			[/impact_text] [blank_spacer height='80px' width='1/1' el_position='first last'] [team_carousel category='All' excerpt_length='25' width='1/1' el_position='first last'] [blank_spacer height='30px' width='1/1' el_position='first last'] [tweets_slider title='Latest tweets from the team' twitter_username='@cootheme' text_size='large' tweets_count='6' autoplay='yes' alt_background='alt-four' el_class='bt0 bb0 mb0 no-arrow' width='1/1' el_position='first last']";
			
		} else if ($template_id == "ct-our-offices") {
		
			$template_code = "[blank_spacer height='10px' width='1/1' el_position='first last'] [spb_slider layerslider_shortcode='1' width='1/1' el_position='first last'] [blank_spacer height='65px' width='1/1' el_position='first last'] [spb_text_block title='Welcome to Coo' pb_margin_bottom='no' pb_border_bottom='no' width='1/3' el_position='first']
		...
		} else if ($template_id == "ct-pricing") {
			...
			Coo is registered with Cybertrust as an authentic site. This ensures that your information is kept private while in transit between your web browser and our web server.
			...
			To give you even more confidence in shopping online with Coo, we have introduced MasterCard&reg; SecureCodeTM. This service protects your existing card account from unauthorised use when you shop with us.
			...
			Please note: Your MasterCard&reg; SecureCode password is not your Coo account password. Coo does not have access to your MasterCard&reg; SecureCode password.
			
			[/spb_text_block] [spb_text_block title='Faster Shopping' pb_margin_bottom='no' pb_border_bottom='no' width='1/2' el_position='last']
			
			Coo also provides the option for you to safely store your credit card details, making it quicker and simpler to shop with us. Your full card details will never be displayed, except for the last four digits so that you know which of your cards you are using. You can delete your card details by unchecking the box 'remember my payment details' on the payment page.
		...
		} else if ($template_id == "ct-privacy") {
			...
			Coo strives, to the fullest extent possible, to provide accurate and updated content on this website. Unfortunately, there may occasionally be price changes, sold out goods and other unintentional errors on our site. We reserve the right not to be liable for these errors or changes and neither Coo, nor any employee or representative of Coo will be liable for damages arising from the use of this website or the products sold here.
			
			[/spb_text_block] [spb_text_block title='Applicable Law' pb_margin_bottom='no' pb_border_bottom='no' width='1/2' el_position='last']
			
			Any dispute arising between a customer and Coo will be settled in accordance with British Legislation.
			
			[/spb_text_block]";
			
		} else if ($template_id == "ct-services") {
		
			$template_code = "[fullwidth_text alt_background='alt-four' el_class='mt0 bt0 bb0 no-arrow' width='1/1' el_position='first last']
			
			[one_third]
			<p style='text-align: center;'><img class='alignnone size-full wp-image-11233' alt='services_strat3' src='http://cootheme.com/wp-content/uploads/2012/08/services_strat3.png' width='720' height='369' /></p>
			...
			[/one_third]
			[one_third]
			<p style='text-align: center;'><img class='alignnone size-full wp-image-11232' alt='services_creat3' src='http://cootheme.com/wp-content/uploads/2012/08/services_creat3.png' width='720' height='369' /></p>
			
			<h3 style='text-align: center;'>Creativity</h3>
			<p style='text-align: center;'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse viverra mauris eget tortor imperdiet vehicula. Proin egestas diam ac mauris molestie hendrerit. Quisque nec nisi tortor. Etiam at mauris sit amet magna suscipit hend merit non sed ligula. Vivamus purus odio.</p>
			[/one_third]
			[one_third_last]
			<p style='text-align: center;'><img class='alignnone size-full wp-image-11231' alt='services_tech3' src='http://cootheme.com/wp-content/uploads/2012/08/services_tech3.png' width='720' height='369' /></p>
			...
			[ct_iconbox image='' character='1' type='left-icon' title='We're great people' animation='fade-from-left' animation_delay='0']
			...
			[ct_iconbox image='' character='2' type='left-icon' title='We're dedicated' animation='fade-from-left' animation_delay='600']
			Suspendisse bibendum cursus luctus. Donec consequat malesuada felis at faucibus. Nulla dapibus malesuada libero, ut iaculis elit mattis quis. Sed nec dui tortor, ut venenatis libero. Etiam venenatis, nisl sit amet vestibulum molestie.
			[/ct_iconbox]
			
			&nbsp;
			
			[ct_iconbox image='' character='3' type='left-icon' title='We're diligent' animation='fade-from-left' animation_delay='1200']
			Suspendisse bibendum cursus luctus. Donec consequat malesuada felis at faucibus. Nulla dapibus malesuada libero, ut iaculis elit mattis quis. Sed nec dui tortor, ut venenatis libero. Etiam venenatis, nisl sit amet vestibulum molestie.
			[/ct_iconbox]
			
			[/spb_text_block] [spb_text_block pb_margin_bottom='no' pb_border_bottom='no' width='1/2' el_position='last']
			
			[ct_iconbox image='' character='4' type='left-icon' title='We're caring' animation='fade-from-right' animation_delay='300']
			Suspendisse bibendum cursus luctus. Donec consequat malesuada felis at faucibus. Nulla dapibus malesuada libero, ut iaculis elit mattis quis. Sed nec dui tortor, ut venenatis libero. Etiam venenatis, nisl sit amet vestibulum molestie.
			[/ct_iconbox]
			
			&nbsp;
			
			[ct_iconbox image='' character='5' type='left-icon' title='We're talented' animation='fade-from-right' animation_delay='900']
			Suspendisse bibendum cursus luctus. Donec consequat malesuada felis at faucibus. Nulla dapibus malesuada libero, ut iaculis elit mattis quis. Sed nec dui tortor, ut venenatis libero. Etiam venenatis, nisl sit amet vestibulum molestie.
			[/ct_iconbox]
			
			&nbsp;
			
			[ct_iconbox image='' character='6' type='left-icon' title='We're intelligent' animation='fade-from-right' animation_delay='1500']
			Suspendisse bibendum cursus luctus. Donec consequat malesuada felis at faucibus. Nulla dapibus malesuada libero, ut iaculis elit mattis quis. Sed nec dui tortor, ut venenatis libero. Etiam venenatis, nisl sit amet vestibulum molestie.
			[/ct_iconbox]
		...
		} else if ($template_id == "ct-services-2") {
			...
			<p style='text-align: left;'>[ct_button colour='gold' type='ct-icon-reveal' size='standard' link='http://' target='_self' icon='ss-phone' dropshadow='no' extraclass='']HIRE US TODAY![/ct_button]</p>
			[/spb_text_block] [spb_text_block pb_margin_bottom='no' pb_border_bottom='no' width='1/4']
			...
			<h3 class='mt0'>Welcome to the Coo flagship store</h3>
			From its beginning in November 2005 as an innovative lifestyle store, the Coo Flagship Store has grown to become one of the best shops in the world.
		...
		} else if ($template_id == "ct-portfolio") {
		...
		} else if ($template_id == "ct-portfolio-example") {
			...
			[ct_iconbox image='ss-view' character='' type='standard' title='999K Views' animation='fade-from-bottom' animation_delay='0']
			
			[/ct_iconbox]
			
			[ct_iconbox image='ss-like' character='' type='standard' title='60k Likes' animation='fade-from-bottom' animation_delay='200']
			
			[/ct_iconbox]
			
			[ct_iconbox image='ss-downloadcloud' character='' type='standard' title='50k Downloads' animation='fade-from-bottom' animation_delay='400']
			...
			<img class='ct-animation' alt='drib-highres' src='http://cootheme.com/wp-content/uploads/2013/11/drib-highres.jpg' width='1140' height='1086' data-animation='fade-from-right' data-delay='200' />
			...
			[ct_countdown year='2013' month='12' day='25' fontsize='large' displaytext='Until the project launches!']
		...
		} else if ($template_id == "ct-blog-example") {
