<?php
	...
	/*
	*
	*	Coo Page Builder - Abstract Class
	*	------------------------------------------------
	*	Cootheme
	...
	*/
	...
	abstract class CTPageBuilderAbstract {
	    ...
	    public function assetURL($asset) {
	        return get_template_directory_uri() . '/coo-theme/page-builder/' . self::$config['SPB_ASSETS'] . $asset;
	    }
	}
