...
class CooPageBuilderShortcode_team_carousel extends CooPageBuilderShortcode {
    ...
    protected function content($atts, $content = null) {
    		...
    		if( have_posts() ) {
    			...
    			$items .= '<div class="carousel-overflow"><ul id="carousel-'.$ct_carouselID.'" class="team-members carousel-items '.$list_class.' clearfix" data-columns="'.$columns.'" data-auto="false">';
    			...
    			while ( have_posts() ) {
    				...
    				$member_bio = ct_excerpt($excerpt_length);
					...
					$items .= '<figcaption><span>'.__("Follow:", "cootheme").'</span><ul class="social-icons">';
					if ($member_twitter) {
    				...
    				$items .= '<div class="team-member-bio">'. $member_bio .'<a href="'.get_permalink().'" class="read-more">'.__("View profile", "cootheme").'</a></div>';
...
SPBMap::map( 'team_carousel', array(
    "name"		=> __("Team Carousel", "coo-page-builder"),
    "base"		=> "team_carousel",
    ...
    "params"	=> array(
		...
		array(
		    ...
		    "value" => "",
		    "description" => __("The length of the excerpt for each of the team members. Default 60.", "coo-page-builder")
		),
        array(
            "type" => "textfield",
