<?php
	...
	*/
	...
	class CooPageBuilderShortcode_spb_accordion_tab extends CooPageBuilderShortcode {
	    ...
	    protected function content( $atts, $content = null ) {
	        ...
	        extract(shortcode_atts(array(
	            'title' => __("Section", "coo-page-builder")
	        ), $atts));
	    ...
	    public function contentAdmin( $atts, $content = null ) {
	        $title = '';
	        $defaults = array( 'title' => __('Section', 'coo-page-builder') );
			...
			<div>
				<div class="row-fluid spb_column_container not-column-inherit">
					'. do_shortcode($content) . CooPageBuilder::getInstance()->getLayout()->getContainerHelper() . '
				</div>
			</div>
		    </div>';
	    }
	...
	class CooPageBuilderShortcode_spb_accordion extends CooPageBuilderShortcode {
	
	    public function __construct($settings) {
	        parent::__construct($settings);
	        CooPageBuilder::getInstance()->addShortCode( array( 'base' => 'spb_accordion_tab' ) );
	    }
	...
	SPBMap::map( 'spb_accordion', array(
	    "name"		=> __("Accordion", "coo-page-builder"),
	    "base"		=> "spb_accordion",
	    "controls"	=> "full",
	    "class"		=> "spb_accordion",
	    ...
	    "params"	=> array(
	        ...
	        array(
	            "type" => "textfield",
	            "heading" => __("Active Section", "coo-page-builder"),
	            "param_name" => "active_section",
	            "value" => "",
	            "description" => __("You can set the section that is active here by entering the number of the section here. NOTE: The first section would be 0, second would be 1, and so on. Leave blank for all sections to be closed by default.", "coo-page-builder")
	        ),
	        array(
	            "type" => "textfield",
		...
		<div class="tab_controls">
			<button class="add_tab">'.__("Add section", "coo-page-builder").'</button>
		</div>
	    ...
	    'default_content' => '
		<div class="group">
			<h3><a class="title-text" href="#">'.__('Section 1', 'coo-theme-admin').'</a><a class="delete_tab"></a><a class="edit_tab"></a></h3>
			<div>
		...
		<div class="group">
			<h3><a class="title-text" href="#">'.__('Section 2', 'coo-theme-admin').'</a><a class="delete_tab"></a><a class="edit_tab"></a></h3>
			<div>
				<div class="row-fluid spb_column_container spb_sortable_container not-column-inherit">
					[spb_text_block width="1/1"] '.__('This is a text block. Click the edit button to change this text.', 'coo-theme-admin').' [/spb_text_block]
				</div>
