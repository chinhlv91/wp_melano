<?php
	...
	/*
	*
	*	Coo Page Builder - Tour Shortcode
	*	------------------------------------------------
	*	Cootheme
	...
	*/
	...
	class CooPageBuilderShortcode_spb_tour extends CooPageBuilderShortcode {
	    ...
	    public function contentAdmin($atts, $content = null) {
	        ...
	        global $ct_tour_pane_count;
	        
	        $ct_tour_pane_count = 0;
	...
	SPBMap::map( 'spb_tour', array(
	    "name"		=> __("Tour Section", "coo-page-builder"),
	    "base"		=> "spb_tour",
	    "controls"	=> "full",
	    "class"		=> "spb_tour",
		"icon"		=> "spb-icon-tour",
	    ...
	    "params"	=> array(
	        ...
	        array(
	            "type" => "dropdown",
	            "heading" => __("Auto rotate slides", "coo-page-builder"),
	            "param_name" => "interval",
	            "value" => array(0, 3, 5, 10, 15),
	            "description" => __("Auto rotate slides each X seconds. Select 0 to disable.", "coo-page-builder")
	        ),
	        array(
	            "type" => "textfield",
		...
		<div class="tab_controls">
			<button class="add_tab">'.__("Add slide", "coo-page-builder").'</button>
		</div>
	    ...
	    'default_content' => '
		<ul>
			<li><a href="#tab-1"><span>'.__('Slide 1', 'coo-theme-admin').'</span></a><a class="delete_tab"></a><a class="edit_tab"></a></li>
			<li><a href="#tab-2"><span>'.__('Slide 2', 'coo-theme-admin').'</span></a><a class="delete_tab"></a><a class="edit_tab"></a></li>
		</ul>
