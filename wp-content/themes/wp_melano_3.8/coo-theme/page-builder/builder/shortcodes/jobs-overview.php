...
class CooPageBuilderShortcode_jobs_overview extends CooPageBuilderShortcode {
    ...
    public function content( $atts, $content = null ) {
        ...
        if ($view_all_link == "yes") {
        	...
        	$jobs_page = __($options['jobs_page'], 'cootheme');
        	if ($jobs_page) {
        	...
        	if ($jobs_page && isset($jobs_page_title)) {
	        	$items .= '<a href="'.get_permalink($jobs_page_id).'" class="read-more">'.__("View all vacancies", "cootheme").' ['.$current_jobs.']</a>';
        	}
        }
...
SPBMap::map( 'jobs_overview', array(
    "name"		=> __("Jobs Overview", "coo-page-builder"),
    "base"		=> "jobs_overview",
    "class"		=> "",
    ...
    "params"	=> array(
    	...
    	array(
    	    "type" => "textfield",
    	    "heading" => __("Intro Text", "coo-page-builder"),
    	    "param_name" => "job_text",
    	    "value" => __("", "coo-page-builder"),
    	    "description" => __("Enter the intro text for the jobs overview.", "coo-page-builder")
    	),
        array(
            "type" => "textfield",
            "class" => "",
            ...
            "value" => "3",
            "description" => __("The number of jobs to show in the overview list. Leave blank to show ALL jobs.", "coo-page-builder")
        ),
        array(
            "type" => "dropdown",
        ...
        array(
            "type" => "dropdown",
            "heading" => __("View all link", "coo-page-builder"),
            "param_name" => "view_all_link",
            "value" => array(__('Yes', "coo-page-builder") => "yes", __('No', "coo-page-builder") => "no"),
            "description" => __("Show the view all jobs link. Make sure you have selected the page within theme options for this to work.", "coo-page-builder")
        ),
        array(
            "type" => "textfield",
