<?php
	/*
	*
	*	Coo Page Builder - Raw Content Shortcodes Config
	*	------------------------------------------------
	*	Cootheme
	...
	*/
	...
	class CooPageBuilderShortcode_spb_raw_html extends CooPageBuilderShortcode {
	...
	SPBMap::map( 'spb_raw_html', array(
		"name"		=> __("Raw HTML", "coo-page-builder"),
		"base"		=> "spb_raw_html",
		"class"		=> "div",
		...
		"params"	=> array(
			array(
				...
				"holder" => "div",
				"class" => "",
				"heading" => __("Raw HTML", "coo-page-builder"),
				"param_name" => "content",
				"value" => base64_encode("<p>This is a raw html block.<br/>Click the edit button to change this html.</p>"),
				"description" => __("Enter your HTML content.", "coo-page-builder")
			),
		)
	) );
	
	class CooPageBuilderShortcode_spb_raw_js extends CooPageBuilderShortcode_spb_raw_html {
	/*
	    public function content( $atts, $content = null ) {
	...
	*/
	...
	SPBMap::map( 'spb_raw_js', array(
		"name"		=> __("Raw JS", "coo-page-builder"),
		"base"		=> "spb_raw_js",
		"class"		=> "div",
		...
		"params"	=> array(
			array(
				...
				"holder" => "div",
				"class" => "",
				"heading" => __("Raw js", "coo-page-builder"),
				"param_name" => "content",
				"value" => __(base64_encode("alert('Enter your js here!');"), "coo-page-builder"),
				"description" => __("Enter your Js.", "coo-page-builder")
			),
		)
	) );
