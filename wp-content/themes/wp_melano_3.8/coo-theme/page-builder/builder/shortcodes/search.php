...
class CooPageBuilderShortcode_search_widget extends CooPageBuilderShortcode {
    ...
    protected function content($atts, $content = null) {
            ...
            $search_form .= '<input type="text" placeholder="'.$search_input_text.'" name="ct-search" />';
            $search_form .= '</form>';
...
SPBMap::map( 'search_widget', array(
    "name"		=> __("Search", "coo-page-builder"),
    "base"		=> "search_widget",
    ...
    "params"	=> array(
    	array(
    	    "type" => "textfield",
    	    "heading" => __("Input placeholder text", "coo-page-builder"),
    	    "param_name" => "search_input_text",
    	    "value" => "Search",
    	    "description" => __("Enter the text that appearas as default in the search input.", "coo-page-builder")
    	),
    	array(
    	    "type" => "dropdown",
    	...
    	array(
    	    "type" => "dropdown",
    	    "heading" => __("Border above widget", "coo-page-builder"),
    	    "param_name" => "pb_border_top",
    	    "value" => array(__('No', "coo-page-builder") => "no", __('Yes', "coo-page-builder") => "yes"),
    	    "description" => __("Add a top border to the widget.", "coo-page-builder")
    	),
    	array(
    	    "type" => "textfield",
