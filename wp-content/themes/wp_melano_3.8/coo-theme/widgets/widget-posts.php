<?php
	...
	*/
	...
	// Register widget
	add_action( 'widgets_init', 'init_ct_recent_posts' );
	function init_ct_recent_posts() { return register_widget('ct_recent_posts'); }
	
	class ct_recent_posts extends WP_Widget {
		function ct_recent_posts() {
			parent::WP_Widget( 'ct_recent_custom_posts', $name = 'Cootheme Recent Posts' );
		}
			...
			<ul class="recent-posts-list">
				...
				<li>
					...
					<div class="recent-post-details">
						...
						<span><?php printf(__('By %1$s on %2$s', 'cootheme'), $post_author, $post_date); ?></span>
