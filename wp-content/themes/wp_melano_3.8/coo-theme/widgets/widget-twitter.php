...
class Twitter_Widget extends WP_Widget {
	...
	function Twitter_Widget() {
		...
		// Create the widget
		$this->WP_Widget('twitter-widget', 'Cootheme Tweets', $widget_ops);
	}
	...
	function widget($args, $instance) {
		...
		$result .= ct_latest_tweet($tweets, $username);
...
?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('username'); ?>"><?php _e('Your Twitter username:', 'coo-theme-admin'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('posts'); ?>"><?php _e('Display how many tweets?', 'coo-theme-admin'); ?></label>
