	...
	*/
	...
	class ct_flickr_widget extends WP_Widget {
		...
		function ct_flickr_widget() {
			...
			$this->WP_Widget( 'flickr-widget', 'Cootheme Flickr Widget', $widget_ops);
		}
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('flickr_id'); ?>"><?php _e('Flickr ID', 'coo-theme-admin');?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Number of Photos', 'coo-theme-admin');?>:</label>
	...
	add_action( 'widgets_init', 'ct_load_flickr_widget' );
	
	function ct_load_flickr_widget() {
