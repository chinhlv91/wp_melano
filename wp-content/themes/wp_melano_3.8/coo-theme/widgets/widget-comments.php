<?php
	...
	*/
	...
	// Register widget
	add_action( 'widgets_init', 'init_ct_recent_comments' );
	function init_ct_recent_comments() { return register_widget('ct_recent_comments'); }
	
	class ct_recent_comments extends WP_Widget {
		function ct_recent_comments() {
			parent::WP_Widget( 'ct_recent_custom_comments', $name = 'Cootheme Recent Comments' );
		}
								...
								<div class="comment-meta">
									<?php
										...
										printf('<span class="comment-author">%1$s</span> <span class="comment-date">%2$s</span>',
											...
											human_time_diff( $comment_date, current_time('timestamp') ) . ' ' . __("ago", "cootheme")
										);
									?>
								</div>
