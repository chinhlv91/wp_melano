<?php
	...
	*/
	...
	// Register widget
	add_action( 'widgets_init', 'init_ct_portfolio_grid' );
	function init_ct_portfolio_grid() { return register_widget('ct_portfolio_grid'); }
	
	class ct_portfolio_grid extends WP_Widget {
		function ct_portfolio_grid() {
			parent::WP_Widget( 'ct_custom_portfolio_grid', $name = 'Cootheme Portfolio Grid' );
		}
