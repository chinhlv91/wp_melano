<?php
	...
	*/
	...
	// Register widget
	add_action( 'widgets_init', 'init_ct_recent_portfolio' );
	function init_ct_recent_portfolio() { return register_widget('ct_recent_portfolio'); }
	
	class ct_recent_portfolio extends WP_Widget {
		function ct_recent_portfolio() {
			parent::WP_Widget( 'ct_recent_custom_portfolio', $name = 'Cootheme Recent Portfolio' );
		}
