	...
	*/
	...
	$meta_boxes[] = array(
		...
		'fields' => array(
			...
			array(
				...
				'desc' => __('Choose the background for the page title (configured in the Coo Options panel).', $text_domain),
			),
	...
	$meta_boxes[] = array(
		...
		'fields' => array(
			...
			// COO SLIDER ENTRY SECTION
			array (
				'name' 	=> '',
				'title' => __('Coo Slider Entry Options', $text_domain),
			    'id' 	=> "{$prefix}heading_detail",
			    'type' 	=> 'section'
			),
			
			// COO SLIDER BACKGROUND IMAGE
			array(
				'name'  => __('Slide background image', $text_domain),
				'desc'  => __('The image that will be used as the slide image in the Coo Slider.', $text_domain),
				'id'    => "{$prefix}posts_slider_image",
				'type'  => 'image_advanced',
				'max_file_uploads' => 1
			),
			
			// COO SLIDER CAPTION POSITION
			array(
